...
export const PLAN_CONFIG: Record<SubscriptionPlan, PlanPricing> = {
  ...
  basic: {
    ...
    priceUSD: 2,
    aiCredits: 20,
    creditValidity: "Valid 1–3 months",
    pricePerCredit: 2450,
    features: [
      "20 additional AI credits",
  ...
  advanced: {
    ...
    highlighted: true,
    aiCredits: 50,
    creditValidity: "Valid 3–6 months",
    pricePerCredit: 1980,
    features: [
      "50 AI credits (lower cost per credit)",
